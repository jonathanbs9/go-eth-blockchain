...
import (
	...
	Models "github.com/jonathanbs9/go-eth-blockchain/models"
	Modules "github.com/jonathanbs9/go-eth-blockchain/modules"
)
...
func (client ClientHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	// Hanlde each request using the module parameter:
	switch module {
	case "latest-block":
